...
Useful links:
The list with HMI keys for PHYSOBS is available at:
https://sdac.virtualsolar.org/cgi/show_details?keyword=PHYSOBS

Finding and downloading data using fido:
https://docs.sunpy.org/en/stable/guide/acquiring_data/fido.html#downloading-data

Jsoc and VSO attributes for searches and filtering searches:
https://docs.sunpy.org/en/stable/code_ref/net.html#
"""
###############################################################################
...
#check other attributes that can be used in a Fido search at: 
#https://docs.sunpy.org/en/stable/code_ref/net.html#module-sunpy.net.vso.attrs
